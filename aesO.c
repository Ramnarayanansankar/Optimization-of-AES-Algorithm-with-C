...
#include <stdlib.h>
#include <time.h>
//you are not allowed to add any other .h functions and you are not
//allowed to use harware encryption.
//if you use hardware encrytpion, you will receive 0 point
